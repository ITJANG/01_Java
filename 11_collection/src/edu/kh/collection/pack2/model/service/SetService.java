...
public class SetService {
	...
	public void method1() {
		...
		System.out.println("검사 : " + set.contains("쿠팡"));
		System.out.println("검사 : " + set.contains("삼성"));
	...
	public void method2() {
		...
		// -> 빈 List 생성
		// --> addAll() 메서드나 생성자 등을 이용해 Set 요소들을 List에 추가
	...
	public void method3() {
		...
		for(Person personSets : personSet) {
			System.out.println(personSets);
		}
		
		// 같은 필드 값을 가진 객체는 해쉬코드가 같다
		 ...
		 * -> 기본 오름차순 정렬
		 * * TreeSet 안에 저장되는 객체는 Comperrable 인터페이스 상속 필수
		 * -> Integer은 Comparable 상속 되어있음
		 * 
		 */
		public void method4() {
		...
		public void lottoNumberGenerator() {
			...
			// 생성된 로또 번호 묶음(TreeSet)을 저장할 List 생성
